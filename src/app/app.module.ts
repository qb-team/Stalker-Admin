...
import {OrganizationTrackingDataServiceService} from './services/OrganizationTrackingDataService.service';
...
@NgModule({
  ...
  providers: [AuthenticationService, OrganizationService, AdministratorDataService, AccessDataService, OrganizationTrackingDataServiceService, { provide: RouteReuseStrategy, useClass: RouteReuseService }],
